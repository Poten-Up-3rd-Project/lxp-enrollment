...
public class EnrollmentCreatedIntegrationEvent extends BaseIntegrationEventEnvelope<EnrollmentEventPayload> {

    private static final String SOURCE = "lxp.enrollment.service";

    public EnrollmentCreatedIntegrationEvent(@JsonProperty("eventId") String eventId,
